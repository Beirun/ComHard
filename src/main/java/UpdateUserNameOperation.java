    ...
    public void userNameCheck(){
        try {
            ...
            if(newUser.exists() || userNameField.getText().isEmpty()){
                ...
                newDashboardPanel.homePanel = new HomePanel(newDashboardPanel,userNameField.getText());
                newDashboardPanel.sidebarPanel = new SidebarPanel(frame, newDashboardPanel.homePanel,  newDashboardPanel.accountPanel, newDashboardPanel.favoritesPanel, newDashboardPanel.associatesPanel, newDashboardPanel, signPanel,userNameField.getText());
                newDashboardPanel.homePanel.setVisible(false);
                newDashboardPanel.accountPanel = new AccountPanel(frame,signPanel, newDashboardPanel,userNameField.getText());
                ...
                newDashboardPanel.add(newDashboardPanel.sidebarPanel,BorderLayout.WEST);
